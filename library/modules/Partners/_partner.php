<?php 
/*
Module Name:    Partner Module
Developer URI:  http://www.DivTruth.com
Description:    Module for adding/managing {module-name} partners post types
Version:        1.0
Author:         Nick Worth
Author URI:     http://www.nickworth.com
Dependencies: 
	# ACF: http://wordpress.org/extend/plugins/advanced-partners-fields/
INSTRUCTIONS:
...
function init_partners_module(){ #STEP 1
  # Register Module
  ...
  /*********** Set Review Template ************/
   add_filter( 'page_template', 'partners_page_template' ); #STEP 3
   function partners_page_template( $page_template ){
  ...
  /********** Set Single Template ***********/
  add_filter( 'single_template', 'partners_single_template' ); #STEP 3 (continued)
